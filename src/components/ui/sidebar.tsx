      ...
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        ...
        >
          <SheetHeader className="sr-only">
            <SheetTitle>{fa.sidebar.mobileSidebarTitle}</SheetTitle>
            <SheetDescription>{fa.sidebar.mobileSidebarDescription}</SheetDescription>
          </SheetHeader>
...
function SidebarTrigger({
  ...
  return (
    ...
    >
      <PanelLeftIcon />
      <span className="sr-only">{fa.sidebar.toggle}</span>
    </Button>
  )
}
...
function SidebarRail({ className, ...props }: React.ComponentProps<"button">) {
  ...
  return (
    <button
      ...
      aria-label={fa.sidebar.toggle}
      tabIndex={-1}
      onClick={toggleSidebar}
      title={fa.sidebar.toggle}
      className={cn(
